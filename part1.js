...
rl.on('line', function(line)
{
  ...
  else
  {
    ...
    data=csv2array(line);
    var header=data[0];
    if(header[PrimaryType]==='THEFT')
    {
      if((header[Description]==='OVER $500')||(header[Description]==='$500 AND UNDER'))
      {
    ...
    obj[header2]=header[Description];
    obj[header3]=header[Year];
    console.log(obj);
    var json_convert=JSON.stringify(obj);
    fs.appendFile('json_file1.json',json_convert);
  }
}
